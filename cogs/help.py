...
prefix = '!'
bot_title = 'Кот'
bot_description = 'Бот для модерации'
bottom_info = 'Бот для модерации, сделан за 150 рублей на бесплатном хостинге, обнова: никогда. Я не знаю зачем вообще его сделал'
